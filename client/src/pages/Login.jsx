    ...
    <div className="min-h-screen flex items-center justify-center px-4 landing-root">
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.75rem', fontWeight: 700, margin: 0, color: 'var(--color-text)' }}>Welcome back</h1>
          <p style={{ color: 'var(--color-muted)', marginTop: '0.4rem', fontSize: '0.9rem' }}>Sign in to your workspace</p>
        </div>
